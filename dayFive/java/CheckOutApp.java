...
public class CheckOutApp{
    ...
    public static String getCustomerInfo(){
        String name;
        while(true) {
            System.out.print("What is your customer's name? ");
            name = inputCollector.nextLine().trim();
    ...
    public static void main(String[] args) {
        ...
        double actualAmount = moneyReceived - finalAmount;
...
==========================================================
                           Bill Total:          %.2f
==========================================================
KINDLY COLLECT YOUR CHANGE OF %.2f
==========================================================
...
%.2f
        ...
        """, subtotal, discount, vat, finalAmount, actualAmount, moneyReceived);
